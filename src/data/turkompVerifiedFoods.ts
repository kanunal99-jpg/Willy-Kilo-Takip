...
export const TURKOMP_VERIFIED_FOODS: FoodItem[] = [
  ...
  {
    id: 'turkomp-nohut-kocbasi-kuru-07020003',
    name: 'Nohut, Koçbaşı, kuru',
    calories: 334,
    protein: 18.56,
    carbs: 41.35,
    fat: 5.33,
  ...
  {
    id: 'turkomp-fasulye-dermason-kuru-08020026',
    name: 'Fasulye, dermason, kuru',
    calories: 281,
    protein: 21.75,
    carbs: 29.42,
    fat: 1.35,
  ...
  {
    id: 'turkomp-mercimek-kirmizi-kuru-07020001',
    name: 'Mercimek, kırmızı, kuru',
    calories: 322,
    protein: 25.81,
    carbs: 41.94,
    fat: 1.57,
  ...
  {
    id: 'turkomp-nohut-haslanmis-konserve-08020055',
    name: 'Nohut, haşlanmış, konserve',
    calories: 106,
    protein: 5.31,
    carbs: 16.01,
    fat: 0.98,
