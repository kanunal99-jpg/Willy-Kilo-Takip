...
export const APP_VERSION: AppVersionInfo = {
  ...
  apkUrl: 'https://github.com/kanunal99-jpg/Willy-Kilo-Takip/releases/download/v1.0.23/WillyKiloTakip-v1.0.23.apk',
  ...
  releaseNotes: [
    ...
    'OTA düzeltmesini taşıyan Android bootstrap release: 1.0.23 / versionCode 24',
  ],
};
